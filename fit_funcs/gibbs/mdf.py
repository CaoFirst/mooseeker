# -*- coding: utf-8 -*-
# @Author: Caoyh
# @Date:   2022-06-13 19:50:45
# @Last Modified time: 2022-06-14 21:09:30
...
# Import scripts
import kegg_helper.pykegg as pykegg
...
def read_reactions(reactions_text, proton_name = "C00080"):
    ...
    for line in reactions_text.split("\n"):
        ...
        # exclude a condition that one kind of compound both in substrates and products
        counts = {}
        for idx, key in enumerate(compounds):
            if key in counts:
                counts[key] += 1
                compounds[idx] = f'{key}_{counts[key]}'
            else:
                counts[key] = 0
...
if __name__ == "__main__":
    ...
    reactions = 'examples/E_coli.model.tab'
    std_drG = 'E_coli.model_drgs.tab'
    outfile = 'E_coli_Lys_nem.csv'
    ...
    main(reaction_file=reactions, 
         std_drG_file=std_drG, 
         outfile_name=outfile, 
         cons_file=constraints,
         ratio_cons_file=ratios, 
         pw_rxn_file=pathway,
         all_directions=all_direction)
